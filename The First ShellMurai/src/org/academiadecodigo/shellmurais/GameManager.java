...
/*    Thread reloadMenu = new Thread(new Runnable() {
        @Override
        public void run() {
    ...
    public void moveAll() /*throws Exception*/ {
            ...
            for (GameObject gameObject : gameObjects) {
                ...
                if (gameObject instanceof Platform) { continue; }
            ...
            if (questCompleted) {
                ...
                catch (Exception e){ System.out.println("fudeu"); }
                ...
                if (level <= 3) {
                    ...
                    catch (Exception e){ System.out.println("Error image"); }
    ...
    public void restartLevel(Player player) {
        ...
        try { Thread.sleep(1000); System.out.println("OIIII");}
        catch (Exception e){ System.out.println("Error image"); }
        gameOverImg.delete();
        player.relocate();
