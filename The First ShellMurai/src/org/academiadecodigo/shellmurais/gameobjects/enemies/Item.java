...
public class Item extends Enemy{
    ...
    public int getCounterItem() { return counterItem; }

    public void setCounterItem(int counterItem) { this.counterItem = counterItem; }
    ...
    @Override
    protected void walk(int moveSpeed, int delay) /*throws Exception*/ {
        /*try {
